...
├── MEMBERSHIP_LAUNCH_PLAN.md  ← business plan: which niche to launch + 4-week content plan
├── bootcamp/              ← August 11+ Summer Bootcamp: brief, marketing pack, flyer, landing-page mockup
...
- [ ] **Phase 6 — Resources & Membership** (subscription content library — build only after validating demand; see `MEMBERSHIP_LAUNCH_PLAN.md`)
